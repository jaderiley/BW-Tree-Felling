...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "BW Tree Felling",
    phone:     "082 468 0590",
    whatsapp:  "082 468 0590",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "BW Tree Felling — Tree felling in johannesburg",
    description: "BW Tree Felling provides professional tree felling in Johannesburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "BW Tree Felling handles tree felling, stump removal and trimming across Johannesburg and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "BW Tree Felling team at work in Johannesburg",
